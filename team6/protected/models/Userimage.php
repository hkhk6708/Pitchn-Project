 ...
 *
 * The followings are the available columns in table 'userimage':
 * @property integer $id
...
class Userimage extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('email, path, filename', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, email, path, filename, date, current', 'safe', 'on'=>'search'),
		);
	}
